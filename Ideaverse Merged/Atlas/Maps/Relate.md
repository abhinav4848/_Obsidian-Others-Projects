...
>
> > [!Sailboat]+ ## Boats 🚤
> > You probably made these notes in a rush. These [[Ideaverse Merged/Atlas/Dots/Things/BOAT notes]] are _lonely boats floating in an empty ocean_. All you need to do is tether them to other notes.
> >
> > ```dataview
> > LIST
> > FROM #note/boat🚤
