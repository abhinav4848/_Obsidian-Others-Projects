...
up:
  - "[[ACE Headspace]]"
related:
  - "[[Ideaverse Merged/Atlas/Notes/Statements/Use STIR To Remember More]]"
created: 2023-08-21
---
The reason why the [[ACE Headspace]] works is because it allows you to organize by *Intention*.
...
ACE works because it matches the "STI" of [[Ideaverse Merged/Atlas/Notes/Statements/Use STIR To Remember More|STIR]] (the universal elements of organizing).
...
So that's when I had my “aha” moment: The “STI” of STIR can map to the [[ACE Headspace]]—and in the process give us a universal folder system that ***optimizes for recall!*** 
...
While I liked the aesthetic of 6 folders, there is something too powerful in how ACE maps to [[Ideaverse Merged/Atlas/Notes/Statements/Use STIR To Remember More]]. Just put `Cards`, `Sources`, and `Special` under `Atlas` for now.
...
Then, when you're ready, go to [[The ACE Headspace allows for flexible folders]] to customize it.
